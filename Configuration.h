...
#define STRING_CONFIG_H_AUTHOR "M-bit.nl" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MEGATRONICS
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "M-bit Prusa i3"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "b1bd0596-9ef9-4192-a2d1-85c04ce8600c"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  #define  DEFAULT_Ki 5.6 //3.46
  #define  DEFAULT_Kd 97.55
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER -42     // Z probe to nozzle X offset: -left  +right
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,8000,1672}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {200, 200, 1, 40}    // (mm/sec)
...
#define DEFAULT_TRAVEL_ACCELERATION   600    // X, Y, Z acceleration in mm/s^2 for travel (non printing) moves
